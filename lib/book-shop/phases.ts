 ...
 * gendered participle we phrase neutrally if it reads well, otherwise encode
 * both forms as a "{masc|fem}" token (e.g. "{vyrůstal|vyrůstala}"). lib/gender.ts
 * resolves it to masculine, feminine, or a "vyrůstal/a" slash fallback when the
 * recipient's gender is unknown.
 */
...
export const BOOK_PHASES: BookPhase[] = [
  {
    ...
    questions: [
      ...
      { id: "d2", text: "Kde jsi {vyrůstal|vyrůstala}? Popiš dům nebo byt, ve kterém jsi {bydlel|bydlela}.", recommended: true },
      { id: "d3", text: "Jakou hru sis jako dítě nejraději {hrál|hrála} a s kým?", recommended: true },
      ...
      { id: "d9", text: "Kam jsi {jezdil|jezdila} na prázdniny nebo na výlety?" },
      { id: "d10", text: "Jakou největší lumpárnu jsi jako dítě {provedl|provedla}?" },
    ],
  },
  {
    key: "skola",
    ...
    questions: [
      ...
      { id: "s8", text: "Čím jsi {chtěl|chtěla} být, až vyrosteš?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "m2", text: "Kam jsi {jezdil|jezdila} s kamarády? {Měl|Měla} jsi nějaké oblíbené místo?", recommended: true },
      { id: "m3", text: "Jaká hudba se ti líbila, když ti bylo dvacet?", recommended: true },
      { id: "l1", text: "Jak ses {seznámil|seznámila} se svým partnerem? Vzpomínáš si na první setkání?", recommended: true },
      { id: "m4", text: "Jaká byla tvoje první brigáda nebo první výplata?" },
      { id: "m5", text: "Co jsi s partou {dělával|dělávala} o víkendech?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "r5", text: "Jak jsi {vybíral|vybírala} jména pro své děti?" },
  ...
  },
  {
    ...
    title: "Kariéra",
    questions: [
      { id: "p1", text: "Jaké bylo tvoje první zaměstnání? Jak ses k němu {dostal|dostala}?", recommended: true },
      ...
      { id: "p5", text: "{Změnil|Změnila} jsi někdy obor nebo zaměstnání? Proč?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "mo1", text: "Co bys {poradil|poradila} svému dvacetiletému já?", recommended: true },
      ...
      { id: "z1", text: "Jaký koníček tě dlouhodobě baví? Jak ses k němu {dostal|dostala}?", recommended: true },
      ...
      { id: "z5", text: "Je něco, co bys ještě {chtěl|chtěla} zažít?" },
    ],
  },
];
